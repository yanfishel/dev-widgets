    ...
    <>
      ...
      <div className="row">
        { packageJson.homepage &&
          <div id="homepage">
            <a href='#' onClick={() => openExternalLink(packageJson.homepage)}>Homepage</a>
          </div>
        }
      ...
      { packageJson.bugs?.url &&
        <div id="bugs">
          <a href='#' onClick={() => openExternalLink(packageJson.bugs.url)}>Report a bug</a>
        </div>
      }

      <div className="credits">
        <div id="icons-credit">Weather <a href="#" onClick={() => openExternalLink('https://open-meteo.com')}>Open meteo</a></div>
        <div id="icons-credit">Weather icons <a href="#" onClick={() => openExternalLink('https://www.figma.com/@pitsch')}>@pitsch</a></div>
      </div>
    </>
  )
}
